...
for pheno in phenos:
    ...
    adata_result = adata_result[(adata_result.obs['UMAP_1'] >= -6) & (adata_result.obs['UMAP_1'] <= 5.5) & (adata_result.obs['UMAP_2'] >= -4) & (adata_result.obs['UMAP_2'] <= 7)]

    plt.figure(figsize=(10, 21), dpi=100)

    order = ['Beta1', 'Beta2', 'Beta3', 'Beta4', 'Beta5', 'Beta6']
    ...
    ax = sns.swarmplot(data=adata_result.obs,
                       ...
                       # cut=0,
                       orient='h',
                       zorder=1,     # use zorder to order the plot order
                       palette={
                           "Beta1": "#1f77b4",
                           "Beta2": "#ff7f0e",
                           "Beta3": "#2ca02c",
